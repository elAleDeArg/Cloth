...
function NavItems() {
  return (
    <div className="items-center justify-between w-full ms:flex md:w-auto" id="nav-items">
      <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-grey-100 rounded lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-white ">
        {
          isAdminView ? adminNavOptions.map((item) => (
            <li className="cursor-pointer block py-2 pl-3 pr-4 text-grey-900 rounded md:p-0" key={item.id}>
        ...
        <div className="flex md:order-2 space-x-4">
          ...
          onClick={() => setShowPopup(true)} >
            ...
            >
              <path
                fillRule="evenodd"
                d= "M3 5a1 1 0 011-1h2a1 1 0 110 2H4a1 1 0 01-1 1zM3 10a1 1 0 011-1h2a1 1 0 110 2H4a1 1 0 01-1 1zM3 15a1 1 0 011-1h2a1 1 0 1"
